...
def main()->int:
    ...
    try:
        with zipfile.ZipFile(artifact) as archive:
            ...
            if archive.start_dir + archive.sizeCentralDir > artifact_size or archive.sizeCentralDir < 0: raise SystemExit("P4_ARTIFACT_GATE_FAIL invalid_central_directory_extent")
