...
**Last validated HEAD: 22c46e341b61455ab9e243e09c1db6c7c23ec72d — exact-head Release/ASAN/sandbox validation pending
...
FILES_EXPECTED_TO_CHANGE: StreamManager/AssetStreamingQueue/RuntimeAssetStreamBridge runtime and smoke coverage, AssetResourceManager.h/.cpp, VulkanAssetUploader.h/.cpp, Tests/Runtime/asset_resource_manager_smoke.cpp, Tests/Runtime/vulkan_asset_uploader_smoke.cpp, Tests/Runtime/runtime_asset_stream_bridge_smoke.cpp, Tests/Runtime/neo_runtime_asset_stream_smoke.cpp, Source/NeoEngine/CMakeLists.txt, .github/workflows/p1-p3-sandbox-validation.yml, BRANCH_STATUS.md
...
RELEASE_TARGETS: canonical P1 target set; manifest count 81, pending exact-head CI
ASAN_TARGETS: same canonical P1 target set; manifest count 81, leak detection enabled, pending exact-head CI
