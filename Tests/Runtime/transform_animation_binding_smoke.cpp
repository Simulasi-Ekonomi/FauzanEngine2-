...
int main() {
    ...
    if(invalid.Add({{0xFFFF,0},"walk-x",TransformChannel::PositionX,1,0})||invalid.LastError()!=TransformAnimationError::InvalidBinding||!missing.Add({{999,1},"walk-x",TransformChannel::PositionX,1,0})||missing.Apply(world,timeline,0,AnimationPlayback::Clamp)||missing.LastError()!=TransformAnimationError::MissingEntity) return 1;
