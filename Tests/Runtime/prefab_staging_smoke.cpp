...
int main() {
    ...
    std::printf("PREFAB_STAGING_SMOKE_OK ready=1 stale=1 diagnostics=1 atomic=1 sessionPreserved=1 combinedPlan=1 rollback=1 receiptHashes=1 receiptsPreserved=1 actors=%u\n", session.World().AliveCount());
    return 0;
}
