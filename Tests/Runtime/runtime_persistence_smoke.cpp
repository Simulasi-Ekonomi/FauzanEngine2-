...
int main() {
    ...
    saveBytes=RuntimeSaveEnvelope{"farm-world",7,{1,2,3,4,5}}.payload; if(saveBytes.size()!=5U) return 1;
    ...
    std::printf("RUNTIME_PERSISTENCE_SMOKE_OK settings=2 atomic=1 save=1 checksum=1 sensitive=1 failure_state=1\n");return 0;
}
