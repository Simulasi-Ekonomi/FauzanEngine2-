...
`gameplay_physics_query_smoke` membuktikan raycast nearest-hit, mapping `EntityID`, mask layer yang memfilter hit, input NaN, miss, invalid mask, dan preservasi hit pada kegagalan. Target lulus Release dan ASAN `detect_leaks=1`; broad non-Vulkan lulus **102/102 Release** dan **102/102 ASAN**.
