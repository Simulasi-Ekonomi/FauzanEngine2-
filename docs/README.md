...
| Editor scene sprite binder atomic | [`EDITOR_SCENE_SPRITE_BINDER_ATOMIC_V1.md`](EDITOR_SCENE_SPRITE_BINDER_ATOMIC_V1.md) | Candidate-commit texture staging with atomic SceneSpriteAdapter replacement. |
...
| Neo runtime Farm render receipt | [`NEO_RUNTIME_FARM_RENDER_RECEIPT_V1.md`](NEO_RUNTIME_FARM_RENDER_RECEIPT_V1.md) | Committed world/HUD hashes with copied telemetry for one successful runtime render. |
...
| Material refresh surface atomic | [`MATERIAL_REFRESH_SURFACE_ATOMIC_V1.md`](MATERIAL_REFRESH_SURFACE_ATOMIC_V1.md) | Finite visual proof of atomic MTL refresh and scene rebind through AssetRefreshExecutor. |
...
| Grid navigation atomic output | [`GRID_NAVIGATION_ATOMIC_OUTPUT_V1.md`](GRID_NAVIGATION_ATOMIC_OUTPUT_V1.md) | Candidate-commit route output preservation on path-query failure. |
