...
struct NeoRuntimeFrameReceipt { RuntimeClockSnapshot clock{}; RuntimeTimeSnapshot time{}; ActorComponentWorldReceipt actors{}; FarmTelemetrySnapshot farm{}; FarmWorldSnapshot world{}; uint32_t dispatchedEventCount = 0U; RuntimeFarmRenderReceipt farmRender{}; InputStateSummary input{}; AssetRegistrySummary assets{}; uint32_t sceneAliveEntityCount = 0U; bool hasFarmRenderReceipt = false; };
