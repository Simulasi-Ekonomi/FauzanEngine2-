...
enum class FarmActionPanelError : uint8_t { None, NotInitialized, InvalidConfiguration, DuplicateWidget, DuplicateAction, UnknownWidget, BridgeNotReady, RouterRejected };
