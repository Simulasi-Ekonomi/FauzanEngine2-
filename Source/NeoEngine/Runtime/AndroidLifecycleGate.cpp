...
bool AndroidLifecycleGate::Shutdown(){if(state_!=AndroidLifecycleState::Initialized&&state_!=AndroidLifecycleState::Active&&state_!=AndroidLifecycleState::Paused){lastError_=AndroidLifecycleError::InvalidTransition;return false;}state_=AndroidLifecycleState::Fresh;tickCount_=0;lastError_=AndroidLifecycleError::None;return true;}
} // namespace NeoEngine
