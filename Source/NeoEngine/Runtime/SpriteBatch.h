...
enum class SpriteBatchError : uint8_t { None, Capacity, InvalidSize, InvalidSourceRect, ProjectionFailed, DrawFailed };
struct SpriteDraw { float x = 0.0F, y = 0.0F, z = 1.0F, width = 1.0F, height = 1.0F; int16_t layer = 0; int16_t order = 0; uint32_t rgba = 0xFFFFFFFFU; const CpuTextureResource* texture = nullptr; float rotationRadians = 0.0F; bool faceCamera = false; bool depthWrite = true; uint16_t sourceX = 0U, sourceY = 0U, sourceWidth = 0U, sourceHeight = 0U; };
