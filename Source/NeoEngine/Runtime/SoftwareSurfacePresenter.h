...
enum class SoftwareSurfacePresenterError : uint8_t { None, InvalidConfiguration, SdlInitFailed, WindowFailed, RendererFailed, TextureFailed, NotInitialized, DimensionMismatch, UploadFailed };
