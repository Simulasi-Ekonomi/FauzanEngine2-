...
bool FarmRuntimeHud::EnsureLayout(SoftwareRenderer& renderer) {
    ...
    if (!enhanced) {
        ...
        const std::vector<UiWidgetSpec> widgets{{1U,0U,{0,0,1,1},1,false,true,false},{2U,1U,{0,0,1,1},2,false,true,false},{3U,1U,{0,0,1,1},3,false,true,false},{4U,1U,{0,0,1,1},4,false,true,false},{5U,1U,{0,0,1,1},5,false,true,false},{6U,1U,{0,0,1,1},6,false,true,false},{7U,1U,{0,0,1,1},7,false,true,false},{8U,1U,{0,0,1,1},8,false,true,false},{10U,0U,{0,0,1,1},9,false,true,false},{11U,10U,{0,0,1,1},10,true,true,true},{12U,10U,{0,0,1,1},11,true,true,true},{13U,10U,{0,0,1,1},12,true,true,true},{14U,10U,{0,0,1,1},13,true,true,true}};
        for (const UiWidgetSpec& widget : widgets) if (!candidateRouter.AddWidget(widget)) return false;
        const std::vector<UiLayoutSpec> plan{{1U,UiLayoutAnchor::TopLeft,UiLayoutFlow::None,{2,2,2,2},62,92,62,92,0},{2U,UiLayoutAnchor::TopLeft,UiLayoutFlow::VerticalStack,{2,2,2,2},0,9,20,9,0},{3U,UiLayoutAnchor::TopLeft,UiLayoutFlow::VerticalStack,{2,2,2,2},0,9,20,9,0},{4U,UiLayoutAnchor::TopLeft,UiLayoutFlow::VerticalStack,{2,2,2,2},0,9,20,9,0},{5U,UiLayoutAnchor::TopLeft,UiLayoutFlow::VerticalStack,{2,2,2,2},0,9,20,9,0},{6U,UiLayoutAnchor::TopLeft,UiLayoutFlow::VerticalStack,{2,2,2,2},0,9,20,9,0},{7U,UiLayoutAnchor::TopLeft,UiLayoutFlow::VerticalStack,{2,2,2,2},0,9,20,9,0},{8U,UiLayoutAnchor::TopLeft,UiLayoutFlow::VerticalStack,{2,2,2,2},0,9,20,9,0},{10U,UiLayoutAnchor::TopRight,UiLayoutFlow::None,{2,2,2,2},58,64,58,64,0},{11U,UiLayoutAnchor::TopLeft,UiLayoutFlow::VerticalStack,{2,2,2,2},0,10,20,10,2},{12U,UiLayoutAnchor::TopLeft,UiLayoutFlow::VerticalStack,{2,2,2,2},0,10,20,10,2},{13U,UiLayoutAnchor::TopLeft,UiLayoutFlow::VerticalStack,{2,2,2,2},0,10,20,10,2},{14U,UiLayoutAnchor::TopLeft,UiLayoutFlow::VerticalStack,{2,2,2,2},0,10,20,10,2}};
...
bool FarmRuntimeHud::ConfigureCanvas(const FarmRuntimeFrameReceipt& receipt, FarmPlayerAction selectedAction, const AssetRegistry* registry, const CpuTextureResource* panelIcon, UiCanvasRenderer& canvas) const {
    ...
    const bool labels=canvas.SetLabel({2U,"FRAME "+std::to_string(receipt.frame),2U,2U,1U,0xFFFFFFFFU})&&canvas.SetLabel({3U,"COINS "+std::to_string(receipt.telemetry.coins),2U,2U,1U,0xFFFFFFFFU})&&canvas.SetLabel({4U,"TICK "+std::to_string(receipt.telemetry.simulationTick),2U,2U,1U,0xFFFFFFFFU})&&canvas.SetLabel({5U,"GROW "+std::to_string(receipt.telemetry.growingTiles),2U,2U,1U,0xFFFFFFFFU})&&canvas.SetLabel({6U,InputStatus(receipt.input),2U,2U,1U,0xFFFFFFFFU})&&canvas.SetLabel({7U,"WHEAT "+std::to_string(receipt.inventory.wheatProduce),2U,2U,1U,0xFFFFFFFFU})&&canvas.SetLabel({8U,"SEED "+std::to_string(receipt.inventory.wheatSeeds),2U,2U,1U,0xFFFFFFFFU})&&canvas.SetLabel({11U,"TILL",2U,2U,1U,0xFFFFFFFFU})&&canvas.SetLabel({12U,"PLANT",2U,2U,1U,0xFFFFFFFFU})&&canvas.SetLabel({13U,"WATER",2U,2U,1U,0xFFFFFFFFU})&&canvas.SetLabel({14U,"HARVEST",2U,2U,1U,0xFFFFFFFFU});
    ...
    return labels&&image&&canvas.SetStyle({1U,0xD0202020U})&&canvas.SetStyle({2U,0xC0202020U})&&canvas.SetStyle({3U,0xC0202020U})&&canvas.SetStyle({4U,0xC0202020U})&&canvas.SetStyle({5U,0xC0202020U})&&canvas.SetStyle({6U,0xC0202020U})&&canvas.SetStyle({7U,0xC0202020U})&&canvas.SetStyle({8U,0xC0202020U})&&canvas.SetStyle({10U,0xD0202020U})&&canvas.SetStyle({11U,ActionColor(selectedAction,FarmPlayerAction::Till)})&&canvas.SetStyle({12U,ActionColor(selectedAction,FarmPlayerAction::PlantWheat)})&&canvas.SetStyle({13U,ActionColor(selectedAction,FarmPlayerAction::Water)})&&canvas.SetStyle({14U,ActionColor(selectedAction,FarmPlayerAction::Harvest)});
}
