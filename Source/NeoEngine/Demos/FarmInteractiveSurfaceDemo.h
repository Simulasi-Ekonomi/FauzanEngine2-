...
struct FarmInteractiveSurfaceDemoReceipt { uint64_t frames = 0U; uint64_t presentedFrames = 0U; uint64_t worldFramebufferHash = 0U; uint64_t hudFramebufferHash = 0U; FarmPlayerAction selectedAction = FarmPlayerAction::Till; FarmTelemetrySnapshot telemetry{}; FarmRuntimeInventorySnapshot inventory{}; };
