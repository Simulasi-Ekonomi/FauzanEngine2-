...
public:
    ...
    void SetServerPublicKey(const std::string& key);
    void SetOnCheatDetected(std::function<void(const std::string&, const std::string&)> cb);
    void SetOnVerified(std::function<void(const std::string&)> cb);
    void MarkAllPlayerItemsContaminated(const std::string& playerId, const std::string& playerName);
    bool TransferOwnership(const std::string& serial, const std::string& fromId,
...
private:
    ...
    std::unordered_map<std::string, std::vector<std::string>> m_AuditTrail;
    ...
    std::string GenerateSerialLocked(const std::string& itemType, const std::string& itemName);
    std::string RegisterGeneratedItemLocked(const std::string& ownerId, const std::string& itemType,
                                            const std::string& itemName, int quantity,
                                            const std::string& source);
    void AddAuditLocked(const std::string& playerId, const std::string& entry);
